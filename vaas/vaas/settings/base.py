...
CELERY_REDIS_SOCKET_TCP_KEEPIDLE = env.int('REDIS_SOCKET_TCP_KEEPIDLE', default='300')
CELERY_REDIS_SOCKET_TCP_KEEPCNT = env.int('REDIS_SOCKET_TCP_KEEPCNT', default='5')
CELERY_REDIS_SOCKET_TCP_KEEPINTVL = env.int('REDIS_SOCKET_TCP_KEEPINTVL', default='45')
