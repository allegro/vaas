...
JAZZMIN_SETTINGS = {
    ...
    "icons": {
        ...
        "cluster.dc": "fas fa-server",
        "cluster.domainmapping": "fas fa-sitemap",
        "cluster.logicalcluster": "fas fa-cubes",
        "cluster.varnishserver": "fas fa-cloud",
        "cluster.vcltemplateblock": "fas fa-file-code",
        "cluster.vcltemplate": "fas fa-file-alt",
        "cluster.vclvariable": "fas fa-tags",
        "manager.backend": "fas fa-cogs",
        "manager.director": "fas fa-users-cog",
