...
from vaas.external.audit import AuditBulkDelete
...
class VarnishServerAdmin(admin.ModelAdmin, AuditBulkDelete):
...
class VclTemplateAdmin(SimpleHistoryAdmin, AuditBulkDelete):
