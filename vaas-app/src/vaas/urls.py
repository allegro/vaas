...
from vaas.manager.api import ProbeResource, DirectorResource, BackendResource, TimeProfileResource, \
    ReloadTaskResource
from vaas.router.api import RouteResource, RouteConfigurationResource, RoutesTestRequest, RoutesTestTaskResult
...
v01_api.register(RoutesTestRequest())
v01_api.register(RoutesTestTaskResult())
